...
import { BackButton, Fade, PhoneMockup, Label, AccentDivider, SectionH, Body, Section, InfoCard, MetaRow, CaseStudyFooter, CaseStudyShell } from '../components/case-study/CaseStudyComponents'
    ...
    <CaseStudyShell>
      ...
      <section className="min-h-screen px-6 md:px-[6vw] pt-24 pb-16 md:pt-28 md:pb-20">
        <div className="max-w-[600px] mb-12">
                    <Fade delay={0.08}>
            <h1 className="font-display font-normal text-[clamp(32px,5vw,64px)] leading-[1.08] mb-6">
              We were losing to TikTok.
              <span className="block text-star/70 font-display font-normal italic">So we killed our entire lesson format.</span>
            </h1>
          </Fade>
          <Fade delay={0.15}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
          ...
          <Fade delay={0.06}>
            <div className="bg-accent/10 border border-accent/20 rounded-2xl p-5 md:p-6">
              ...
              <div className="font-sans font-bold text-sm text-star mb-1.5">Readers</div>
              <div className="text-xs leading-relaxed text-star/40">Want depth. Willing to invest time. Underserved by almost every learning app. We chose this.</div>
            </div>
          </Fade>
          <Fade delay={0.12}>
            <div className="bg-accent/10 border border-accent/20 rounded-2xl p-5 md:p-6">
              <div className="text-xl mb-2">{"\u{1F3A7}"}</div>
              <div className="font-sans font-bold text-sm text-star mb-1.5">Listeners</div>
              <div className="text-xs leading-relaxed text-star/40">Story driven. Retain through narrative. Also underserved. We designed for this too.</div>
            </div>
          </Fade>
        </div>
      </Section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
          {[
            ...
            <Fade key={i} delay={0.04*i}>
              <div className="bg-star/[0.03] border border-star/[0.06] rounded-xl p-5">
                <div className="font-sans font-bold text-sm text-star mb-1.5">{t}</div>
                <div className="text-xs leading-relaxed text-star/35">{d}</div>
              </div>
            </Fade>
          ))}
        </div>
      ...
      <Section>
        ...
        <Fade delay={0.18}>
          <div className="flex gap-10 md:gap-16 justify-center flex-wrap">
            <div className="text-center">
              <p className="font-sans text-[10px] tracking-[0.15em] text-accent uppercase mb-4">V1 / Cards</p>
              <div className="flex gap-3"><PhoneMockup src={I.v1_card1} width={150} /><PhoneMockup src={I.v1_card2} width={150} /></div>
            </div>
            <div className="text-center">
              <p className="font-sans text-[10px] tracking-[0.15em] text-accent uppercase mb-4">V2 / Articles</p>
      ...
      <Section className="bg-card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-[700px] mt-7">
          <Fade delay={0.08}>
            <div className="bg-star/[0.03] border border-star/[0.06] rounded-xl p-6">
              <h4 className="font-display text-xl text-star mb-2">Relatability</h4>
              <p className="text-sm leading-relaxed text-star/40">Story blocks put you in someone else's shoes. "Imagine you are on a first date and the conversation dies." Now it is personal. Now the concept sticks.</p>
            </div>
          </Fade>
          <Fade delay={0.14}>
            <div className="bg-star/[0.03] border border-star/[0.06] rounded-xl p-6">
              <h4 className="font-display text-xl text-star mb-2">Remembrance</h4>
              <p className="text-sm leading-relaxed text-star/40">Brains remember stories better than facts. A week later, in a real situation, users recall the story. And with the story comes the concept and what to do about it.</p>
            </div>
          </Fade>
        </div>
      </Section>
