...
class GalleryApp {
  ...
  addEventListeners() {
    ...
    // Scope interaction events to the container so page scroll isn't hijacked
    ...
    el.addEventListener('touchstart', this.boundOnTouchDown);
    el.addEventListener('touchmove', this.boundOnTouchMove);
